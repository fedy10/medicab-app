...
import { ChevronLeft, ChevronRight, Plus, Check, X, Search, Clock, User, Edit, Trash2 } from 'lucide-react';
    ...
    if (newAppointment.patientName && newAppointment.patientPhone && newAppointment.time) {
      ...
      setAppointments([
        ...appointments,
        {
          ...
          date: selectedDate.toISOString().split('T')[0], // Added date field
        ...
        {showAddAppointment && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl max-h-[85vh] overflow-y-auto"
            >
              ...
              <div className="space-y-3">
                <div>
                  <label className="block text-sm text-gray-700 mb-1">Nom du patient</label>
                ...
                <div>
                  <label className="block text-sm text-gray-700 mb-1">Type de paiement</label>
                  <select
                ...
                <div>
                  <label className="block text-sm text-gray-700 mb-1">Montant payé</label>
                  <input
                    type="number"
                ...
                <div className="flex gap-3 mt-5 pt-3 border-t border-gray-200">
                  <button
                    onClick={() => {
                      setShowAddAppointment(false);
                      setEditingAppointment(null);
                  ...
                  <button
                    ...
                    className="flex-1 bg-gradient-to-r from-blue-500 to-purple-600 text-white py-2.5 rounded-xl hover:shadow-lg transition-all"
                  >
